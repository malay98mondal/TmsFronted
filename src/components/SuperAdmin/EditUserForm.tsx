...
const EditUserForm: React.FC<EditUserFormProps> = ({ initialValues, onSubmit, onCancel }) => {
    ...
    return (
        <form onSubmit={formik.handleSubmit}>
            ...
            />
                ...
                <Grid item xs={12} sm={6}>
                    <InputLabel sx={{fontSize:'15px',marginBottom:'5px'}}>
                        <FaStarOfLife style={{ color: 'red', fontSize: '8px',marginBottom:'5px' }} />
                        Ext ##
                    </InputLabel>
                ...
                <Grid item xs={12} sm={6}>
                    <InputLabel sx={{fontSize:'15px',marginBottom:'5px'}}><FaStarOfLife style={{ color: 'red', fontSize: '8px',marginBottom:'5px' }} />Phone ##</InputLabel>
                    <TextField
                        fullWidth
                        size="small"
                        id="ph_no"
