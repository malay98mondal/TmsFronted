...
// import decodeTheToken from "../../middleware/tokenDecoder";
// import { fetchAdminNotifications, markAdminNotificationAsRead, fetchAdminNotificationsAll } from "../../apiRequest/Notifications/adminNotification";
...
const Navbar = () => {
  ...
  return (
    <Box sx={{ display: 'flex', height: '60px', alignItems: 'center', justifyContent: 'space-between', background: '#0A152F', margin: 0 }}>
      ...
      <Avatar sx={{ width: 35, height: 35 }} />
        ...
        <Tooltip title="Org Dashboard">
            <Link to='/org-dashboard'>
            <StyledButton size="small" isActive={isActive('/super-admin-dashboard')} style={{marginLeft:'1em'}}>
            </StyledButton>
            </Link>
          </Tooltip>

          <Link to="/org-dashboard/users-table">
          <StyledButton size="small" isActive={isActive('/super-admin-dashboard')}>            </StyledButton>
            </Link>
