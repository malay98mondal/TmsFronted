...
export default function DataRenderLayoutUserGroup({ children }:any) {

    const navigationArray = [
        // {
        //   id: 1,
        //   name: "Location",
        //   path: "/user-dashboard/groups-location",
       ...
       
        {
          id: 2,
          name: "Contact",
          path: "/user-dashboard/groups-contact",
          icon: (
            <Box
              sx={{
                display: 'flex',
  ...
  
        {
          id: 3,
          name: "Hours",
          path: "/user-dashboard/groups-hours",
          icon: (
            <Box
              sx={{
                display: 'flex',
        ...
        },
        {
          id: 4,
          name: "Billing",
          path: "/user-dashboard/groups-billing",
          icon: (
            <Box
              sx={{
                display: 'flex',
